 ...
 *
 * Where:
 * **C[G_0,G_1,...,M_0,M_1,...,N_0,N_1,...] = Sum_{K_0,K_1,...} A[G_0,G_1,...,M_0,M_1,...,K_0,K_1,...] *
 ...
 * ```
 * Original: E[g,m_0,m_1,n_0,n_1] = Sum_{k_0,k_1} A[g,m_0,m_1,k_0,k_1] * B[g,n_0,n_1,k_0,k_1]
 * Flattened: E[g,M,N] = Sum_K A[g,M,K] * B[g,N,K]  (where M=m_0*m_1, N=n_0*n_1, K=k_0*k_1)
 * GEMM Form: E = A * B^T
 *
